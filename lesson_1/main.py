            ...
            <div class="card bg-primary">
                <div class="card-body text-white">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">+7 888 888 888 888</div>
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form>
                        ...
                        <div class="mb-3">
                            <textarea name="message" class="form-control" placeholder="Сообщение" id="exampleFormControlTextarea1" rows="3"></textarea></div>
